...
var notifyError = function(title, message) {
  ...
  exec("gmessage --nofocus --borderless --buttons '' --geometry 500x80 --wrap --timeout 5 --bg red \"" + title + ": " + message + "\"");
};

var notifyOk = function(title, message) {
  console.log(title, message);
  exec("gmessage --nofocus --borderless --buttons '' --geometry 500x80 --wrap --timeout 3 --bg green \"" + title + ": " + message + "\"");
};
...
autotest(files, status_reporting, "jhannes@coffee.k33x.com:mine.k33x.com/");
